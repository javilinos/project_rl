...
# export AEROSTACK2_PATH=$HOME/a2rl/a2rl_ws/aerostack2_ws/src/aerostack2
export AEROSTACK2_PATH=$HOME/aerostack2_ws/src/aerostack2
source $AEROSTACK2_PATH/as2_cli/setup_env.bash
source /root/psdk_ws/install/setup.bash
export ACADOS_SOURCE_DIR=/root/external_libs/mpc/acados
...
# A2RL workspace sources
# source /root/a2rl/.bin/sources.bash
